"""
Database session management for FinDoc Intelligence Agent.
...
from fin_doc_intel.db.models import Base
import os
...
DATABASE_URL = os.getenv(
    ...
    f"{os.getenv('PGHOST', 'localhost')}:{os.getenv('PGPORT', '5433')}/{os.getenv('PGDATABASE', 'findoc_db')}"
)
