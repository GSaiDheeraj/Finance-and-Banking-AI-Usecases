...
class Config:
    ...
    def from_env(cls) -> "Config":
        ...
        return cls(
            llm_endpoint=os.getenv("LLM_ENDPOINT") or os.getenv("LLM_BASE_URL", "https://llm-dev.fdscloud.io/"),
            llm_api_key=os.getenv("LLM_API_KEY", ""),
            llm_model_name=os.getenv("LLM_MODEL_NAME") or os.getenv("LLM_MODEL", "anthropic.claude-4-5-haiku"),
            llm_temperature=float(os.getenv("LLM_TEMPERATURE", "0.0")),
            llm_max_tokens=int(os.getenv("LLM_MAX_TOKENS", "4096")),
            embed_model_name=os.getenv("EMBED_MODEL_NAME") or os.getenv("EMBED_MODEL", "openai.text-embedding-3-large"),
            embed_dim=int(os.getenv("EMBED_DIM", "1536")),
            pg_host=os.getenv("PGHOST") or os.getenv("PG_HOST", "localhost"),
            pg_port=int(os.getenv("PGPORT") or os.getenv("PG_PORT", "5432")),
            pg_database=os.getenv("PGDATABASE") or os.getenv("PG_DATABASE", "fraud_detection_db"),
            pg_user=os.getenv("PGUSER") or os.getenv("PG_USER", "fraud_detection_user"),
